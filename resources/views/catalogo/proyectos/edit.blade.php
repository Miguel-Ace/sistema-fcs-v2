...
@section('informacion')
    ...
    <div class="datos-mostrar">
        <form class="marco" action="{{url('/proyectos'.'/'.$dato->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="contenedor-inputs">
                <div class="inputs">
                    <label for="proyecto" class="encabezado-input">Proyecto</label>
                    <input type="text" class="input" name="proyecto" id="proyecto" value="{{$dato->proyecto}}">
                </div>
            </div>
