...
@section('informacion')
    ...
    <div class="datos-mostrar">
        <form class="marco" action="{{url('/insumos'.'/'.$dato->id)}}"  method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="contenedor-inputs">
                <div class="inputs">
                    <label for="insumo" class="encabezado-input">Insumo</label>
                    <input type="text" class="input" name="insumo" id="insumo" value="{{$dato->insumo}}">
                </div>
            </div>
